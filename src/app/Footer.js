      ...
      <div className="footer-container">
        <div className="container">
          <footer className="row">
            <div className="col-5 col-lg-5 col-sm-12 col-12 mb-4">
            ...
            <div className="col-3 col-lg-3 col-sm-4 col-6 mb-4">
              <span>Patch Types </span>
              <ul className="nav flex-column">
                <li className="nav-item ">
                  <Link href="/custom/embroidered-patches" className="nav-link ">
                    Embroidered Patches
                  </Link>
                </li>
                <li className="nav-item ">
                  <Link href="/custom/printed-patches" className="nav-link ">
                    Printed Patches
                  </Link>
                </li>
                <li className="nav-item ">
                  <Link href="/custom/pvc-patches" className="nav-link ">
                    PVC Patches
                  </Link>
                </li>
                <li className="nav-item ">
                  <Link href="/custom/woven-patches" className="nav-link ">
                    Woven Patches
                  </Link>
                </li>
                <li className="nav-item ">
            ...
            <div className="col-2 col-lg-2 col-sm-4 col-6 mb-4 social-container">
              <span>Follow Us</span>
              <ul className="nav flex-column">
                <li className="nav-item ">
                  <Link href="#" className="nav-link ">
