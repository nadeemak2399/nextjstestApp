        ...
        <div className="row align-items-start  mt-5 mb-5">
          ...
          <div className="col-4 col-lg-4 col-sm-12 col-cu-12">
            <div className='sidebar-container'>
              <ImageGallery image1="custom-Military-Patches" image2="custom-military-patches-unit" image3="custom-Military-Patches-guard" />
            </div>
          </div>
        </div>
          <div className="form-container">
          <CustomFormInner formPageType="Military patches" formPatchType="Military"/>
          </div>
